...
CH--- declaration of abisq
      ...
      double precision hdecay,gg,Asq,mmmm,mmmm2
...
C   Deal with Higgs decay to b-bbar
      s12=s(1,2)
      hdecay=xn*gwsq*mbot**2/(4d0*wmass**2)*2d0*(s12-4d0*mb**2) 
      hdecay=hdecay/((s12-hmass**2)**2+(hmass*hwidth)**2)
      mmmm=99999999999999d0
      mmmm2=0.000001d0
CH--  multiplication with abisq      
ch      Asq=(as/(3d0*pi))**2/vevsq*
ch     . abisq(mt**2/(hmass**2),mmmm2/(hmass**2))
